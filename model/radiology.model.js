...
const medicalSchemaforRadiology = new mongoose.Schema({
  fullName: {
    type: String,
...
medicalSchemaforRadiology.methods.verifyPassword = async function (password) {
  return bcrypt.compare(password, this.password);
};

medicalSchemaforRadiology.pre('save', async function (next) {
...
module.exports = mongoose.model('radiology', medicalSchemaforRadiology);
