...
exports.createNewRadiology = async (req, res) => {
  ...
  try {
    ...
    await newUser.save();
    const approvalLink = `pharma-manager-copy-2.onrender.com/api/Radiology/approve/radiology/${newUser._id}`;
    const rejectLink = `pharma-manager-copy-2.onrender.com/api/Radiology/reject/radiology/${newUser._id}`;
    const mailOptions = {
      from: email,
